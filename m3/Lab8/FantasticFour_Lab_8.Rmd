...
## Scott Baker
```{r,echo=FALSE}
forMap <- tsunami %>% select(SOURCE_ID, YEAR, LOCATION, LATITUDE, LONGITUDE) %>% filter(LONGITUDE < -60 | LONGITUDE > 105, LATITUDE > -60 & LATITUDE < 75)
forMap
ggmap(map) + geom_point(data = forMap, mapping = aes(x=LONGITUDE,y=LATITUDE))
```
