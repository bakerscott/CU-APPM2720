...
ggplot(data=answersTime)+ geom_smooth(mapping=aes(x=responseTime, y=Score), method="lm", se=FALSE)+ggtitle("Correlation of response time and score of the answer")
```
This graph presents an inverse relationship between response time and the score which the answer receives. The more time it takes for a response to be posed the lower its score will be.
